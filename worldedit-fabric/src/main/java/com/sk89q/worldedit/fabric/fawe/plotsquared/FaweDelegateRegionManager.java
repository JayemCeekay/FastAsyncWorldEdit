...
public class FaweDelegateRegionManager {
    ...
    public boolean setCuboids(
        ...
        TaskManager.taskManager().async(() -> {
            synchronized (FaweDelegateRegionManager.class) {
                World world = FabricAdapter.adapt(FabricUtil.getWorld(area.getWorldName()));
    ...
    public boolean handleClear(
        ...
        TaskManager.taskManager().async(() -> {
            synchronized (FaweDelegateRegionManager.class) {
                ...
                World world = FabricAdapter.adapt(FabricUtil.getWorld(hybridPlotWorld.getWorldName()));
    ...
    public void swap(
        ...
        TaskManager.taskManager().async(() -> {
            synchronized (FaweDelegateRegionManager.class) {
                ...
                World pos1World = FabricAdapter.adapt(FabricUtil.getWorld(pos1.getWorldName()));
                World pos3World = FabricAdapter.adapt(FabricUtil.getWorld(swapPos.getWorldName()));
        ...
        TaskManager.taskManager().async(() -> {
            synchronized (FaweDelegateRegionManager.class) {
                EditSession editSession = WorldEdit
                        ...
                        .world(FabricAdapter.adapt(FabricUtil.getWorld(world)))
                        .checkMemory(false)
                        .fastMode(true)
                        .limitUnlimited()
                        .changeSetNull()
    ...
    public boolean copyRegion(
        ...
        TaskManager.taskManager().async(() -> {
            synchronized (FaweDelegateRegionManager.class) {
                World pos1World = FabricAdapter.adapt(FabricUtil.getWorld(pos1.getWorldName()));
                World pos3World = FabricAdapter.adapt(FabricUtil.getWorld(pos3.getWorldName()));
